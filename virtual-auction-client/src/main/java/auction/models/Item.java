...
public class Item {
    ...
    public Item(UUID id, ItemData data, double openingBid, ItemStatus status, Optional<Instant> auctionStart, Optional<Instant> auctionEnd, Optional<UUID> winningBidder) {
        this.id = id;
        this.data = data;
